      ...
      <div className="h-20 flex items-center justify-center px-4 border-b border-white/10 overflow-hidden">
        {isCollapsed ? (
           ...
           <div className="flex items-center justify-center w-full px-2 relative">
              {/* Toned down glow behind sidebar logo */}
              <div className="absolute inset-0 bg-white/5 blur-lg rounded-full scale-110 pointer-events-none"></div>
              <img 
                src="https://lh3.googleusercontent.com/d/1sHycT8QTEakJWJqbOt-TCucWCAa_t5eJ" 
                alt="ISUZU CUP Logo" 
                className="h-10 w-auto object-contain brightness-110 drop-shadow-[0_0_8px_rgba(255,255,255,0.2)] relative z-10"
              />
           </div>
        )}
      </div>
